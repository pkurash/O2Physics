...
using MyTracksRun2 = soa::Join<aod::Tracks, aod::TracksExtra, aod::pidTPCPi, aod::pidTPCPr>;
using MyTracksRun3 = soa::Join<aod::TracksIU, aod::TracksExtra, aod::pidTPCPi, aod::pidTPCPr>;
...
struct vzeroexample {
  ...
  Configurable<double> v0cospa{"v0cospa", 0.97, "cosine of pointing angle"};
  Configurable<float>  dcav0dau{"dcav0dau", 1.0, "DCA V0 daughters"};
  Configurable<float>  dcanegtopv{"dcanegtopv",  .1, "DCA neg"};
  Configurable<float>  dcapostopv{"dcapostopv",  .1, "DCA pos"};
  ...
  HistogramRegistry registry{
    "registry",
    {
      ...
      {"hMassLambda", "hMassLambda", {HistType::kTH1F, {{200, 1.05f, 1.15f}}}},
      {"hMassAntiLambda", "hMassAntiLambda", {HistType::kTH1F, {{200, 1.05f, 1.15f}}}},
    }
  };
...
struct vzerotemplateexample {
  ...
  HistogramRegistry registry{
    "registry",
    {
      ...
      {"hMassTrueLambda", "hMassTrueLambda", {HistType::kTH1F, {{200, 1.05f, 1.15f}}}},
      {"hMassTrueAntiLambda", "hMassTrueAntiLambda", {HistType::kTH1F, {{200, 1.05f, 1.15f}}}},
    }
  };


  void processRun2(soa::Join<aod::Collisions, aod::EvSels>::iterator const& collision, 
	           soa::Filtered<aod::V0Datas> const& V0s,
	           MyTracksRun2 const&  tracks) 
  {
    if (!collision.sel7()) {
      return;
    }
  ...
  void processV0Candidate(TV0 const& v0, float const& pvx, float const& pvy, float const& pvz)
  {
     ...
     float nsigma_neg_proton = TMath::Abs(negTrackCast.tpcNSigmaPr());
     float nsigma_pos_pion   = TMath::Abs(posTrackCast.tpcNSigmaPi());
...
/*
     if (v0.has_mcParticle()) {
       ...
       if (v0mcparticle.pdgCode() == -3122) registry.fill(HIST("hMassTrueK0Short"), v0.mAntiLambda());
     }
*/
  }
